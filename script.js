...
// Flag per abilitare il carosello dopo il primo scroll
let isCarouselActive = false;

// Funzione per iniziare il carosello dopo il primo scroll
function activateCarousel() {
  if (!isCarouselActive) {
    isCarouselActive = true;

    // Aggiungi l'eventListener per la rilevazione dell'elemento centrato
...
// Attiva il carosello al primo scroll
carousel.addEventListener("scroll", activateCarousel, { once: true });
